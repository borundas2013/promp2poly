...
if __name__ == "__main__":
    ...
    print(f"Predictions - Tg: {mis_result['tg_score']:.2f}, Er: {mis_result['er_score']:.2f}")
    ...
    print(f"Predictions - Tg: {deepseek_result['tg_score']:.2f}, Er: {deepseek_result['er_score']:.2f}")
    ...
    print(f"Predictions - Tg: {llama_result['tg_score']:.2f}, Er: {llama_result['er_score']:.2f}")
