...
if __name__ == "__main__":
    combine_and_deduplicate_csv('LLM_Tuned_COT/Output/all_reactive_pairs_small_model.csv', 'LLM_Tuned_COT/Output/all_reactive_pairs.csv', 'LLM_Tuned_COT/Output/all_reactive_pairs_combined.csv')
