...
class TSMPAnalyzer:
    def __init__(self):
        ...
        self.monomer1, self.monomer2, self.er, self.tg = process_dual_monomer_data(
            'LLM_Tuned_COT/Data/unique_smiles_Er.csv',
            'LLM_Tuned_COT/Data/smiles.xlsx'
        )
    ...
    def draw_molecule_pairs(self, output_dir='LLM_Tuned_COT/Output/Molecules'):
...
if __name__ == "__main__":
    ...
    input_files = [
        'LLM_Tuned_COT/Output/properties_generated_responses_small.json',
        'LLM_Tuned_COT/Output/groups_generated_responses_small.json',
        'LLM_Tuned_COT/Output/mix_generated_responses_small.json'
    ]
