...
model_path = "/ddnB/work/borun22/Transfer_learning/NewCOT/LLM/LLAMA3_2/lama32_qlora_finetuned/"
...
def generate_prompt(prompt, isFinal=False, temperature=0.6):
    ...
    num_samples = 20 if isFinal else 1
...
if len(final_responses) > 0:
    with open('/ddnB/work/borun22/Transfer_learning/NewCOT/LLM/LLAMA3_2/Output_json/properties_generated_responses.json', 'w') as f:
        json.dump(final_responses, f, indent=4)
        
final_responses2=create_group_prompt()
if len(final_responses2) > 0:
    with open('/ddnB/work/borun22/Transfer_learning/NewCOT/LLM/LLAMA3_2/Output_json/group_generated_responses.json', 'w') as f:
        json.dump(final_responses2, f, indent=4)
final_responses3=create_mix_prompt()
if len(final_responses3) > 0:
    with open('/ddnB/work/borun22/Transfer_learning/NewCOT/LLM/LLAMA3_2/Output_json/mix_generated_responses.json', 'w') as f:
