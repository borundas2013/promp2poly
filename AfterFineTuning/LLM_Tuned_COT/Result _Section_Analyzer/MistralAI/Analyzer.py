...
class TSMPAnalyzer:
    ...
    def analyze_and_save_tsmp_data(self, input_files):
        ...
        # Save to CSV
        reactive_df.to_csv('MistraAI/Output/large_model/all_reactive_pairs.csv', index=False)
        non_reactive_df.to_csv('MistraAI/Output/large_model/all_non_reactive_pairs.csv', index=False)
    ...
    def check_combinations_in_dataset(self):
        ...
        reactive_df = pd.read_csv('MistraAI/Output/large_model/all_reactive_pairs.csv')
        non_reactive_df = pd.read_csv('MistraAI/Output/large_model/all_non_reactive_pairs.csv')
    ...
    def draw_molecule_pairs(self, output_dir='MistraAI/Output/large_model/Molecules'):
...
if __name__ == "__main__":
    ...
    input_files = [
        'MistraAI/Output/properties_generated_responses.json',
        'MistraAI/Output/group_generated_responses.json',
        'MistraAI/Output/mix_generated_responses.json'
    ]
