...
if __name__ == "__main__":
    combine_and_deduplicate_csv('MistraAI/Output/all_reactive_pairs_small_model.csv', 'MistraAI/Output/all_reactive_pairs.csv', 'MistraAI/Output/all_reactive_pairs_combined.csv')
