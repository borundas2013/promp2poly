...
if len(final_responses) > 0:
    with open('/ddnB/work/borun22/Transfer_learning/NewCOT/LLM/DeepSeek/output_json/properties_generated_responses_2_s.json', 'w') as f:
        json.dump(final_responses, f, indent=4)
        
final_responses2=create_group_prompt()
if len(final_responses2) > 0:
    with open('/ddnB/work/borun22/Transfer_learning/NewCOT/LLM/DeepSeek/output_json/group_generated_responses_2_s.json', 'w') as f:
        json.dump(final_responses2, f, indent=4)
final_responses3=create_mix_prompt()
if len(final_responses3) > 0:
    with open('/ddnB/work/borun22/Transfer_learning/NewCOT/LLM/DeepSeek/output_json/mix_generated_responses_2_s.json', 'w') as f:
